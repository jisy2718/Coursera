...
+ LSTM이 GRU와 다른점
  ![image-20230902220657506](Week_01.assets/image-20230902220657506.png)
...
+ LSTM
  ...
  + 다이어그램
    ...
    ![image-20230902222149096](Week_01.assets/image-20230902222149096.png)

    + ​	모든 게이트와 tanh에 $a^{<t-1>}, x^{<t>}$ 가 input으로 들어감

    ![image-20230902221200268](Week_01.assets/image-20230902221200268.png)
...
+ RNN의 한계점 예시(개체명인식)
  ...
  + 순방향 RNN 모델 구조
    ...
    ![image-20230904220914684](Week_01.assets/image-20230904220914684.png)

+ BRNN 구조

  ![image-20230904221623615](Week_01.assets/image-20230904221623615.png)
